    ...
    <div className=" flashcard mt-0 mb-96">
      ...
      <section className="Deck display flex flex-row my-2 mx-2 min-h-[50%] ">
        ...
        <div className="flex flex-col bg-red-50 ml-4 w-[14%] space-y-4 pt-4 items-center ">
          <button className="bg-red-700 w-[75%] flex  text-lg" onClick={()=>{
            setModal(!modal)
          }}><span></span><span>Share</span></button>
          <button className="bg-red-700 w-[75%] flex text-lg"><span></span><span>Download</span></button>
          <button className="bg-red-700 w-[75%] flex text-lg"><span></span><span>Share</span></button>
