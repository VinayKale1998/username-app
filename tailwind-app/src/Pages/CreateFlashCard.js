  ...
  return (
    <div className=" bg-white px-1 py-1 ">
      ...
      <div className="main my-2">
        ...
        {/* page header */}
        <div className="Heading my-1 py-1 px-1 mx-auto ml-[28%] sm:ml-[35%]  transition-all">
        ...
        {/* first form */}
        <section className="first-form bg-purple-200 my-1 py-1 px-1  mx-[2%]   flex flex-col sm:mx-[7%] md:mx-[8%] lg:mx-[8%] transition-all shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]">
          ...
          <div className="flex items-start  mx-1 py-1 ">
            ...
            <div className="groupName min-w-[70%] flex flex-col px-[0.2%] py-[0.2%] mx-[0.2%]  my-[0.1%] sm:min-w-[60%] md:min-w-[50%] transition-all">
              ...
              {/* groupInput */}
              <input  className="  bg-white px-1 py-1 x w-[99.8%] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]  text-[12px]  md:text-base lg:text-xl transition-all outline-none hover:border-2 hover:border-purple-700 hover:bg-purple-100  placeholder: " placeholder="Enter Group Name"></input>
            ...
            <div className="max-w-[30%] min-w-[18%]   px-[0.2%] py-[0.2%] ml-[0.4%]  overflow-hidden flex flex-col items-center justify-center">
              ...
              <button className="  shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] flex space-x-1 bg-white px-2 py-1 x w-[99.8%]   transition-all outline-none hover:border-2 hover:border-purple-700 hover:bg-purple-600 hover:text-white items-center justify-center ">
                <span className="pt-[3px] text-xs md:text-base lg:text-xl mx-[1%] text-purple-700 font-extrabold">
                  <FiUpload ></FiUpload>
                </span>{" "}
                <span className="text-[12px] md:text-base lg:text-lg font-bold text-purple-700">
                  {" "}
                  Upload
                </span>
              </button>
          ...
          <div className="groupName max-w-[95%] flex flex-col px-[0.2%] py-[0.2%] mx-1  my-1 sm:max-w-[90%] md:max-w-[85%] lg:max-w-[80%] xl:max-w-[75%] transition-all">
            ...
            <textarea className="  bg-white  my-1 px-1 py-1 x w-[99.8%]   text-[12px]  shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] md:text-base lg:text-xl transition-all outline-none hover:border-2 hover:border-purple-700 hover:bg-purple-100   " placeholder="Enter Group Description"></textarea>
        ...
        <section className=" mt-6 second-form bg-purple-200 my-[0.5%] py-1 px-1 mx-[2%]    flex flex-col sm:mx-[7%] md:mx-[8%] lg:mx-[8%] transition-all shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]">
          ...
          <div className="flex space-x-1 flex-wrap px-1 py-1 mx-1 my-1 grow space-y-1 items-start ">
            {/* index */}
            <h1 className=" w-4 h-4 shrink-0 mt-2 bg-blue-200 px-1 py-1 rounded-full flex items-center justify-center    text-[10px] sm:text-[14px] md:text-[16xpx] lg:text-[20px]  font-bold transtion-all sm:w-6 sm:h-6 md:w-8 md:h-8  lg:w-10 lg:h-10">1 </h1>

            {/*term name input*/}
            <div className="  px-[0.5%]  min-w-[70%]  py-[0.5%] shrink-0 grow-[2]  sm:min-w-[20%]  flex">
              <input className=" px-1 py-1 w-[99.5%] bg-white text-[12px]  shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]  md:text-base lg:text-xl transition-all   " placeholder="Enter Term Name"></input>
            </div>

            {/* term description */}
            <div className="   min-w-[94%]  pl-[3%] py-[0.5%]  grow-[3]   sm:min-w-[50%] sm:pl-[0.2%]  flex">
              <textarea className=" py-1 bg-white  w-[99.5%] px-1 text-[12px]  shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] md:text-base lg:text-xl transition-all overflow-hidden " placeholder="Enter Term Description"></textarea>
            </div>
          
            {/* term image upload */}
            <div className="  px-[3%] py-[1%]  grow-[2] max-w-[30%]   sm:w-auto sm:min-w-[15%] flex  items-center ">
              <button className=" w-[99.5%] px-[0.1%] py-[2%] bg-white  shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]  text-[12px]  md:text-base lg:text-xl transition-all font-bold flex   justify-center">
              <span className="pt-[3px] text-xs md:text-base lg:text-xl  mx-[3%] text-purple-700">
                  <FiUpload></FiUpload>
                </span>{" "}
                <span className="text-[12px]  md:text-base lg:text-lg font-bold text-purple-700 ">
                  {" "}
          ...
          {/* addmore button */}
          <div>
            <button className="bg-white ml-[2%] mx-1 my-1  px-2 py-1 text-purple-800 font-bold text-[12px]  md:text-base lg:text-xl transition-all ">Add More</button>
          </div>
        </section>
        <button
          type="submit"
